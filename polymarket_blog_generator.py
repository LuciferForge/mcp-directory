...
<div class="cta-card">
    ...
    <p>23.0M+ price snapshots across 24,600+ prediction markets. 15-minute frequency, 99+ days of data, updated weekly. Use the same source data behind this post for your own backtests, models, and research.</p>
